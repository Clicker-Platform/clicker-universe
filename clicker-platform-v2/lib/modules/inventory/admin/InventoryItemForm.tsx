        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-xl overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                    <h3 className="font-bold text-lg text-gray-800">{initialData ? 'Edit Item' : 'Add New Item'}</h3>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            ...
                            <input
                                required
                                className="w-full border border-gray-200 p-2.5 rounded-lg focus:ring-2 focus:ring-brand-dark/10 focus:border-brand-dark outline-none transition-all"
                                value={formData.sku}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-sm font-bold text-gray-700">Low Stock Alert</label>
                            <input
                                type="number"
                                required
                                className="w-full border border-gray-200 p-2.5 rounded-lg focus:ring-2 focus:ring-brand-dark/10 focus:border-brand-dark outline-none transition-all"
                    ...
                    <div className="space-y-1.5">
                        <label className="block text-sm font-bold text-gray-700">Linked Menu Item (Optional)</label>
                        <select
                            className="w-full border border-gray-200 p-2.5 rounded-lg focus:ring-2 focus:ring-brand-dark/10 focus:border-brand-dark outline-none transition-all bg-white"
                        ...
                        <p className="text-xs text-gray-500 mt-1">If linked, stock will be automatically deducted when this item is sold.</p>
                    </div>
                    <button
                        type="submit"
