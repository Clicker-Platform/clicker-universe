            ...
            <div className="relative bg-white w-full max-w-md h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50/50">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1 font-medium">{item.name}</p>
                    </div>
                    <button
                        onClick={onClose}
                    ...
                    {loading ? (
                        ...
                        <div className="divide-y divide-gray-100">
                            {transactions.map((tx) => {
                                ...
                                return (
                                    <div key={tx.id} className="p-6 hover:bg-gray-50 transition-colors flex gap-4">
                                        <div className={`
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex justify-between items-start mb-1">
                                                ...
                                                <span className="text-xs font-medium px-2 py-1 rounded-md bg-gray-100 text-gray-600 uppercase tracking-wide">
                                                    {tx.reason}
                                                </span>
                                            </div>
                                            ...
                                            <div className="space-y-1.5 text-sm">
                                                ...
                                                {(tx.notes || tx.referenceId) && (
                                                    <div className="flex items-start gap-2 text-gray-500 mt-2 bg-gray-50 p-2 rounded text-xs">
