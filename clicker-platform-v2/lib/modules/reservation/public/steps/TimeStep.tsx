            ...
            <div className="flex items-center justify-between mb-6 bg-gray-50 p-2 rounded-xl">
                ...
                <div className="text-center relative group cursor-pointer">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <CalendarIcon size={16} className="text-brand-blue opacity-50 group-hover:opacity-100" />
                    </div>
                    {/* Invisible Full Size Date Picker Overlay */}
                    <input
                        type="date"
                        min={todayStr}
                        value={formattedDate}
                ...
                {loadingSlots ? (
                    ...
                    generatedSlots.map((slot: any) => {
                        ...
                        if (isToday) {
                            ...
                            // Buffer: don't allow booking within 30 mins
