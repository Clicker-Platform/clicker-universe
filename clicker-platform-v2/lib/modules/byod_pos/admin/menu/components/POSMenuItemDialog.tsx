...
export function POSMenuItemDialog({ isOpen, onClose, onSave, initialData, isLoading = false, inventoryItems = [] }: POSMenuItemDialogProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl animate-in zoom-in-95 duration-200 border border-gray-100">
                {/* Header */}
                <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50 flex-shrink-0">
                    <div className="flex items-center gap-3 text-brand-dark">
                        <div className="p-2 bg-white rounded-lg shadow-sm text-brand-dark">
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    <form id="pos-item-form" onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="md:col-span-2 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-dark/20 focus:border-brand-dark transition-all"
                                    value={formData.name}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            min="0"
                                            placeholder="0.00"
                                            className="w-full pl-7 pr-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-dark/20 focus:border-brand-dark transition-all"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-dark/20 focus:border-brand-dark transition-all min-h-[100px]"
                            ...
                            <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl border border-gray-200">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-sm font-bold text-gray-700">Visible on POS</span>
                                    <span className="text-xs text-gray-500">Enable or disable this item in the catalog</span>
                                </div>
                            </div>
                        </div>
                            ...
                            {(!formData.variants || formData.variants.length === 0) ? (
                                ...
                                <div className="space-y-3">
                                    {formData.variants.map((variant, index) => (
                                        <div key={variant.id} className="flex flex-col sm:flex-row gap-3 bg-gray-50 p-3 rounded-xl border border-gray-200 items-start sm:items-center relative group">
                                            <div className="flex-1 w-full sm:w-auto">
                                                <input
                                                    placeholder="Variant Name (e.g. Large)"
                                                    className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-brand-dark/20"
                                                    value={variant.name}
                                                    onChange={e => {
                                            ...
                                            <div className="flex-1 w-full sm:w-auto">
                                                <select
                                                    className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-brand-dark/20 bg-white"
                                            ...
                                            <button
                                                ...
                                                className="p-2 text-gray-400 hover:text-red-500 hover:bg-white rounded-lg transition-colors sm:static absolute -top-2 -right-2 sm:shadow-none shadow-sm bg-white sm:bg-transparent border sm:border-none border-gray-100"
                                            >
                                                <X size={16} />
                                            </button>
                                        </div>
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-bold text-gray-700 mb-2">Item Images</label>
