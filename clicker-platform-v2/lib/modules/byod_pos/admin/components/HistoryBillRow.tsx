            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <span className="text-xs text-gray-400 font-medium px-1.5 py-0.5 bg-gray-100 rounded-md">
                ...
                <div className="text-right">
                    ...
                    <div className={`text-xs font-bold uppercase ${group.status === 'paid' ? 'text-green-600' :
                        group.status === 'cancelled' ? 'text-red-600' : 'text-gray-500'
                        }`}>
                        {group.status}
                    </div>
                </div>

                <div className="text-gray-400 group-hover:text-brand-dark transition-colors">
