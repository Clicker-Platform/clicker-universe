    ...
    return (
        <div className="p-6 max-w-3xl space-y-5">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">Configure notification reminders sent after service completion.</p>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm flex items-center justify-between">
                ...
                <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none disabled:opacity-50 ${
                        config.featuresEnabled.reminderEngine ? 'bg-green-500' : 'bg-gray-200'
                    }`}
                >
                ...
                <div className="p-5 border-b border-gray-50">
                    <div className="flex items-center justify-between">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-gray-800">{REMINDER_LABELS.r0.label}</p>
                                <p className="text-xs text-gray-400 mt-0.5">{REMINDER_LABELS.r0.description}</p>
                            </div>
                        </div>
                        <button
                            type="button"
                            ...
                            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors disabled:opacity-50 ${
                                reminders.r0Enabled && config.featuresEnabled.warrantyCards ? 'bg-green-500' : 'bg-gray-200'
                            }`}
                        >
                    ...
                    {!config.featuresEnabled.warrantyCards && (
                        <p className="text-xs text-amber-600 mt-2">Enable warranty cards in Settings to activate R0.</p>
                    )}
                </div>
                ...
                <div className="p-5 border-b border-gray-50">
                    <div className="flex items-center justify-between">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-gray-800">{REMINDER_LABELS.r1.label}</p>
                                <p className="text-xs text-gray-400 mt-0.5">{REMINDER_LABELS.r1.description}</p>
                            </div>
                        </div>
                        <button
                            type="button"
                            ...
                            disabled={!isOwner}
                            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors disabled:opacity-50 ${
                                reminders.r1Enabled ? 'bg-green-500' : 'bg-gray-200'
                            }`}
                        >
                            <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow transition-transform ${
                    ...
                    {reminders.r1Enabled && (
                        <div className="mt-3 flex items-center gap-2">
                            ...
                            <input
                                ...
                                disabled={!isOwner}
                                className="w-16 rounded-lg border border-gray-200 focus:border-gray-400 focus:ring-0 px-2 py-1 text-xs text-center disabled:bg-gray-50"
                            />
                            <span className="text-xs text-gray-600">days after completion</span>
                        </div>
                    )}
                </div>
                ...
                <div className="p-5 border-b border-gray-50">
                    <div className="flex items-center justify-between">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-gray-800">{REMINDER_LABELS.r2.label}</p>
                                <p className="text-xs text-gray-400 mt-0.5">{REMINDER_LABELS.r2.description}</p>
                            </div>
                        </div>
                        <button
                            type="button"
                            ...
                            disabled={!isOwner}
                            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors disabled:opacity-50 ${
                                reminders.r2Enabled ? 'bg-green-500' : 'bg-gray-200'
                            }`}
                        >
                            <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow transition-transform ${
                ...
                <div className="p-5">
                    <div className="flex items-center justify-between">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-gray-800">{REMINDER_LABELS.r3.label}</p>
                                <p className="text-xs text-gray-400 mt-0.5">{REMINDER_LABELS.r3.description}</p>
                            </div>
                        </div>
                        <button
                            type="button"
                            ...
                            disabled={!isOwner || !config.featuresEnabled.warrantyCards}
                            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors disabled:opacity-50 ${
                                reminders.r3Enabled && config.featuresEnabled.warrantyCards ? 'bg-green-500' : 'bg-gray-200'
                            }`}
                        >
                            <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow transition-transform ${
                    ...
                    {reminders.r3Enabled && config.featuresEnabled.warrantyCards && (
                        <div className="mt-3 flex items-center gap-2">
                            ...
                            <input
                                ...
                                className="w-16 rounded-lg border border-gray-200 focus:border-gray-400 focus:ring-0 px-2 py-1 text-xs text-center disabled:bg-gray-50"
                            />
                            <span className="text-xs text-gray-600">days before warranty expiry</span>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mt-0.5">All copy reads from here at dispatch time — never hardcoded.</p>
                    </div>
                </div>
                    ...
                    {(['r0', 'r1', 'r2', 'r3'] as const).map(key => (
                        <button
                            ...
                            className={`flex-1 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                                activeTemplate === key ? 'bg-white shadow text-gray-900' : 'text-gray-500'
                            }`}
                        >
                            {key.toUpperCase()}
                        </button>
                ...
                <div className="space-y-3">
                    <div>
                        ...
                        <input
                            ...
                            disabled={!isOwner}
                            className="w-full rounded-xl border border-gray-200 focus:border-gray-400 focus:ring-0 px-3 py-2 text-sm disabled:bg-gray-50"
                        />
                    </div>
                    <div>
                        ...
                        <textarea
                            ...
                            disabled={!isOwner}
                            rows={6}
                            className="w-full rounded-xl border border-gray-200 focus:border-gray-400 focus:ring-0 px-3 py-2 text-sm resize-none font-mono disabled:bg-gray-50"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                            {TEMPLATE_VARS.map(v => (
                                <code
                                    key={v}
                                    className="text-xs bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded font-mono cursor-pointer hover:bg-gray-200"
                                    onClick={() => {
                                        if (!isOwner) return;
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-3">
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-gray-800">Recent Queue</p>
                    <span className="text-xs text-gray-400">(last 50)</span>
                </div>
                {queue.length === 0 ? (
                    <p className="text-sm text-gray-400 italic">No reminder queue entries yet.</p>
                ) : (
