                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-brand-dark focus:ring-0 outline-none transition font-mono text-sm min-h-[100px]"
                        />
                        <div className="flex justify-end">
                            <button
                                onClick={handleSaveUrls}
                                className="px-4 py-2 text-sm border-2 border-gray-200 rounded-lg hover:border-brand-dark transition"
                            >
                                Save URLs Only
                            </button>
                        </div>
                    ...
                    <div className="space-y-3 border-t pt-4">
                        ...
                        <div className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl p-6 text-center transition-colors hover:bg-white hover:border-purple-300">
