    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="px-3 py-2 border-b border-neutral-800 flex items-center gap-2 flex-shrink-0">
                ...
                <span className="text-xs font-bold text-neutral-400 flex-1">Select Icon</span>
            </div>
            ...
            <div className="px-3 py-2 border-b border-neutral-800 flex-shrink-0">
                <div className="relative">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Search icons…"
                        className="w-full pl-8 pr-3 py-1.5 bg-neutral-800 border border-neutral-700 rounded-lg text-sm text-neutral-200 placeholder-neutral-500 focus:border-blue-500/50 focus:outline-none"
                        value={search}
                        onChange={(e) => setSearch(e.target.value)}
                    />
                </div>
                    ...
                    {filteredIcons.map(name => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className="text-[8px] font-medium truncate w-full text-center text-neutral-500">
                                    {name}
                                </span>
                            </button>
                        );
