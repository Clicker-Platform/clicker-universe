...
import { Settings, Layers, Box, FileText, BarChart2, CheckSquare, Square, X } from 'lucide-react';
...
export function CanvasStudio({
    ...
    return (
        <div className="flex flex-1 overflow-hidden bg-neutral-950">
            ...
            <div className="w-56 bg-neutral-900 border-r border-neutral-800 flex flex-col z-10">
                <div className="p-4 border-b border-neutral-800 font-bold text-sm text-neutral-200 flex items-center gap-2">
                    <Layers size={18} className="text-neutral-400" /> Outline & Blocks
                </div>
                <div className="p-4 overflow-y-auto flex-1 custom-scrollbar">
                     <BlockManager blocks={blocks} onChange={setBlocks} templateId={templateId} />
                </div>
            </div>
                         ...
                         >
                             {/* Full template rendering pipeline - matches live site */}
                                 <div className="flex flex-col h-full bg-white relative">
                                    {/* Top Navbar Slot */}
                                    <div 
                                        className={`z-50 w-full cursor-pointer transition-all flex-shrink-0 ${
                                            ...
                                            <div className="px-4 py-8">
                                                ...
                                                <div className="relative z-10 grid gap-6" style={{ gridTemplateColumns: 'minmax(0, 1fr)' }}>
                                                    {blocks.map((block) => (
                                                        <div
                                                            key={block.id}
                                                            className={`min-w-0 relative transition-all ${block.type === 'hero' ? '' : 'rounded-lg'} ${
            ...
            <div className="w-72 bg-neutral-900 border-l border-neutral-800 flex flex-col z-10">
                ...
                <div className="p-4 overflow-y-auto flex-1 custom-scrollbar bg-neutral-900">
                    {activePanel === 'page' ? (
                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-semibold text-neutral-400 mb-1.5">Title</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-neutral-400 mb-1.5">Slug</label>
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <button
                                        ...
                                        className={`text-xs font-bold flex items-center gap-1 px-2 py-1 rounded-md transition-colors ${
                                            formData.overridePixels
                            ...
                            <div>
                                ...
                                <div className={`space-y-2.5 transition-opacity duration-200 ${formData.overrideSeo ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
                                    <div>
                                        <label className="block text-xs font-semibold text-neutral-500 mb-1">Meta Title</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="block text-xs font-semibold text-neutral-500 mb-1">Meta Description</label>
                                        <textarea
                                    ...
                                    <div>
                                        <label className="block text-xs font-semibold text-neutral-500 mb-1">OG Image URL</label>
                                        <input
                                            type="text"
