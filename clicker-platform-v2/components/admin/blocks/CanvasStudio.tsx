...
export function CanvasStudio({
    ...
    const canvasContent = (
        <div className={`flex-1 flex justify-center bg-neutral-950 relative overflow-y-auto ${isMobile ? 'pb-20' : ''}`}>
            {/* Page switch overlay */}
            {pageLoading && (
            ...
            <div className={`w-full ${deviceView === 'tablet' ? 'max-w-lg' : deviceView === 'mobile' ? 'max-w-md' : ''} shadow-2xl ring-1 ring-white/10 overflow-hidden transition-all duration-300 my-8 self-start isolate`}>
    ...
    if (isMobile) {
        ...
        return (
            <div className="flex flex-col flex-1 overflow-hidden bg-neutral-950 relative">
                {/* Full-width canvas */}
                {canvasContent}
                ...
                >
                    ...
                    {mobileSheet === 'props' && (
                        <div className="flex flex-col h-full">
                            ...
                            <div className="flex items-center gap-1 px-4 py-2 border-b border-neutral-800 flex-shrink-0">
                                <button
                                    type="button"
                                ...
                                {activePanel && (
                                    <button
                                        ...
                                        className="ml-auto p-1.5 rounded-md text-neutral-500 hover:text-neutral-200 hover:bg-neutral-800 transition-colors"
                                    >
                                        <X size={12} />
                                    </button>
                                )}
