                        ...
                        {products.map(product => {
                            ...
                            return (
                                <div
                                    ...
                                    `}
                                >
                                    <div className="w-12 h-12 bg-gray-100 dark:bg-neutral-800/50 rounded-lg flex-shrink-0 overflow-hidden border border-gray-200 dark:border-neutral-700/30">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className={`text-sm font-black truncate ${isSelected ? 'text-neutral-900 dark:text-neutral-100' : 'text-neutral-500 dark:text-neutral-400'}`}>{product.name}</p>
                                        <p className="text-xs font-bold text-neutral-400 dark:text-neutral-500 mt-0.5">{product.price}</p>
                                    </div>
