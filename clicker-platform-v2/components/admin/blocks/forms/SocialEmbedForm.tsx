        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                {items.length === 0 && (
                    <div
                        onClick={handleAddItem}
                        className="text-center py-10 bg-neutral-900/50 rounded-2xl border-2 border-dashed border-neutral-800 text-neutral-500 text-sm cursor-pointer hover:border-neutral-700 hover:bg-neutral-800/50 transition-all group"
                    >
                        <Play size={24} className="mx-auto mb-2 opacity-30 group-hover:opacity-60 transition-opacity" />
                        <p className="font-bold text-neutral-400">No embeds yet</p>
                ...
                <div className="space-y-3">
                    {items.map((item, index) => (
                        <div key={index} className="p-4 bg-neutral-800 rounded-2xl border border-neutral-700 relative group shadow-sm space-y-3">
                            {/* URL + platform badge */}
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-neutral-900 border border-neutral-800 rounded-xl text-sm text-neutral-200 placeholder-neutral-600 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all font-medium"
