...
const RichTextEditor = dynamic(
    ...
    {
        loading: () => (
            <div className="h-[200px] w-full bg-gray-100/50 dark:bg-neutral-900/50 flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 dark:border-neutral-800 text-neutral-400 dark:text-neutral-500 gap-3">
...
export const TextForm = ({ data, onChange }: TextFormProps) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="min-h-[200px] rounded-2xl overflow-hidden border border-gray-200 dark:border-neutral-800 bg-gray-100/50 dark:bg-neutral-900/50">
                <RichTextEditor
