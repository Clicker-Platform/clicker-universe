...
export function AccountMenu({ member, accent, onAccentChange, onClose, onAccount, onLogout }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed left-4 right-4 top-16 sm:absolute sm:left-auto sm:right-0 sm:top-12 z-40 bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.14)] sm:w-[240px] overflow-hidden">
        {view === 'menu' ? (
          <>
