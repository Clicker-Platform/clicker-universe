            ...
            >
                <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-white">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Manually add a new potential customer.</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="new-contact" className="text-sm font-medium text-gray-700">Contact</label>
                        <input
                            id="new-contact"
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black/5 text-sm"
                    ...
                    <div className="space-y-2">
                        <label htmlFor="new-value" className="text-sm font-medium text-gray-700">Value (IDR)</label>
                        <input
                            id="new-value"
                            type="number"
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black/5 text-sm"
