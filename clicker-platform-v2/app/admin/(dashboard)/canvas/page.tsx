            ...
            >
                <div className="flex gap-3">
                    <button
                        ...
                        className="flex-1 px-4 py-2.5 rounded-lg font-bold text-red-500 border border-red-200 dark:border-red-900 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors"
                    >
                        Discard
                    </button>
                    <button
                        ...
                        className="flex-1 px-4 py-2.5 rounded-lg font-bold bg-brand-dark dark:bg-neutral-100 text-white dark:text-neutral-900 hover:opacity-90 transition-opacity"
                    >
                        Save & Switch
                    </button>
                </div>
